...
[all ABCs](https://docs.python.org/3/library/collections.abc.html#collections-abstract-base-classes)

using ABC's allow for more generic typing
see above link with table to see wich ABC you need
...
use pydantic for extra validation & (de)serialization power
